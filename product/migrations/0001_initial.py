...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('order', '0006_delete_orderphoto_alter_order_options_order_image'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='product.category', verbose_name='Категория')),
            ],
            options={
